import { mockProducts, mockAccessories } from './products';
import { mockQuotes, mockCustomers } from './quotes';
...
// 开发环境下使用 Mock 数据
export const useMockInDev = process.env.NODE_ENV === 'development' && !import.meta.env.VITE_USE_REAL_API;
